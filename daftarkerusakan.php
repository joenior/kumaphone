...
while ($data = mysqli_fetch_array ($hasil)){
 			...
 			echo "
        			...
        			<td>".$data[1]."</td>
        			<td>".$data[2]."</td>
                    <td><a href=\"detailkerusakan.php?id=".$data[0]."\"><i class='bi bi-search'></i></a>"."  <a href=\"editkerusakan.php?id=".$data[0]."\"><i class='bi bi-pencil'></i></a>"."  <a href=\"deletekerusakan.php?id=".$data[0]."\" onclick='return checkDelete()'><i class='bi bi-trash3'></i></a>"."</td>
        		</tr>
        	";
			}
}
...
<script language="JavaScript" type="text/javascript">
function checkDelete(){
    return confirm('Yakin menghapus semua history?");
}
</script>
