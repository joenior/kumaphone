...
while ($data = mysqli_fetch_array ($hasil)){
 			...
 			echo "
                    ...
                    <td><a href=\"aeditgejala.php?id=".$data[0]."\"><i class='bi bi-pencil'></i></a>"."  <a href=\"adeletegejala.php?id=".$data[0]."\"  onclick='return checkDelete()'><i class='bi bi-trash3'></i></a>"."</td>
        		</tr>
        	";
			}
}
